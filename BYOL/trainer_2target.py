...
class BYOLTrainer:
    ...
    def update(self, batch_view_modality_1, batch_view_modality_2):
        ...
        predictions_from_modality_view_1_1 = self.predictor(self.online_network_1(batch_view_modality_1))
        predictions_from_modality_view_1_2 = self.predictor(self.online_network_1(batch_view_modality_2))
        predictions_from_modality_view_2_1 = self.predictor(self.online_network_2(batch_view_modality_1))
        predictions_from_modality_view_2_2 = self.predictor(self.online_network_2(batch_view_modality_2))

        # compute key features
        with torch.no_grad():
            targets_to_view_1_1 = self.target_network_1(batch_view_modality_2)
            targets_to_view_1_2 = self.target_network_1(batch_view_modality_1)
            targets_to_view_2_1 = self.target_network_2(batch_view_modality_2)
            targets_to_view_2_2 = self.target_network_2(batch_view_modality_1)
