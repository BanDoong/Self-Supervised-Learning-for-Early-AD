...
class BYOL(nn.Module):
    ...
    def __init__(
        ...
        self.forward(torch.randn(2, 3, image_size, image_size, image_size, device=device))
    ...
    def forward(
        ...
        # image_one, image_two = generate_pair(x, args=self.args)
...
model = BYOL(args=args, net=vit)
summary(model, (4, 1, 128, 128, 128))
